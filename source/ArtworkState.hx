...
class ArtworkState extends MusicBeatState {
    ...
    override function create()
    {
        ...
        //artMusic = new FlxSound().loadEmbedded(Paths.music('songy'), true, true);
		//artMusicc.volume = 0;
		//artMusic.play(false, FlxG.random.int(0, Std.int(pauseMusic.length / 2)));
        ...
        //title = new FlxSprite(376, 30).loadGraphic(Paths.image(menuDirectory + 'title'));
        ...
        curImage.scale.x = curImage.scale.x / 1.5;
        curImage.scale.y = curImage.scale.y / 1.5;        
