...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			...
			['Vasalto',				'vasalto',			'Director, Composer of #1 Song and Menu Song, Coder',		'https://twitter.com/Vasalto3',	'444444'],
			['Tet',					'tet',				'Director, Main Artist/Animator',									'https://twitter.com/ranfringW',			'C30085'],
			['Rotty',				'rotty',			'Charter of #1 Song',									'https://twitter.com/RottySC2',			'4494E6'],
			['AntiMyersDiver2033',	'myers',			'Composer of #2 Song',									'https://twitter.com/FNF_0Disruption',	'4494E6'],
			...
			['TheSlithyGamer4evr',	'slith',			'Beta Tester',											'https://twitter.com/FNF_0Disruption',	'389A58'],
