...
function onCreate()
	if getPropertyFromClass('ClientPrefs', 'lowQuality') == false then
		precacheImage("stages/1/elevatorandtubes/b");
		precacheImage("stages/1/elevatorandtubes/c");
		precacheImage("stages/1/elevatorandtubes/a");
		precacheImage("stages/1/elevatorandtubes/majoras");
		precacheImage("stages/1/elevatorandtubes/dany");
		precacheImage("stages/1/elevatorandtubes/rei");
		precacheImage("stages/1/elevatorandtubes/slithyocho");
		precacheImage("stages/1/elevatorandtubes/myers");
